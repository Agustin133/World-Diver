...
const World = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="py-8 px-4 pb-0">
      ...
      {selectedDestination && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[9999] p-4">
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-8">
              ...
              <div className="mb-6">
                <p className="text-sm font-semibold text-ocean-blue mb-3">Vida Marina Destacada:</p>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 bg-ocean-blue text-white py-3 rounded-lg font-semibold hover:bg-ocean-teal transition-colors flex items-center justify-center"
                >
                  Ver en Destinos
